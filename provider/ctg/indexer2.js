...
const INDEX_FILE =
    path.join(CACHE_DIR, "index2.json");

const STATS_FILE =
    path.join(CACHE_DIR, "stats2.json");

const FOLDERS_FILE =
    path.join(CACHE_DIR, "folders2.json");

const QUEUE_FILE =
    path.join(CACHE_DIR, "queue2.json");

const STATE_FILE =
    path.join(CACHE_DIR, "state2.json");

// ADD HERE
const INDEX_TMP_FILE =
    path.join(CACHE_DIR, "index2.tmp.json");

const FOLDERS_TMP_FILE =
    path.join(CACHE_DIR, "folders2.tmp.json");

const STATS_TMP_FILE =
    path.join(CACHE_DIR, "stats2.tmp.json");
